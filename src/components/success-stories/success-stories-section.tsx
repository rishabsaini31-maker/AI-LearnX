...
import { VideoStoryCard } from './video-story-card';
import { AudioStoryCard } from './audio-story-card';
import { WrittenStoryCard } from './written-story-card';
import { StoryModal } from './story-modal';
import { SUCCESS_STORIES } from './data';
import { StoryCategory, Story, VideoStory, AudioStory, WrittenStory } from './types';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-[#111827] tracking-tight mb-6">
            AI LearnX <span className="text-[#2563EB]">Success Stories</span>
          </h1>

          {/* Subtitle */}
          <p className="text-base sm:text-lg text-[#6B7280] max-w-3xl mx-auto leading-relaxed">
            Real stories from students who transformed their careers through real-world projects, mentor guidance, and hands-on learning.
          </p>
        </motion.div>
        ...
        <div className="flex items-center justify-between border-b border-[#E5E7EB] pb-4 mb-8">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold text-[#111827] uppercase tracking-wide">
              {activeCategory === 'video' && 'Video Stories'}
              {activeCategory === 'audio' && 'Audio Stories'}
              {activeCategory === 'written' && 'Written Stories'}
            </h2>
          </div>
        ...
        {filteredStories.length > 0 ? (
          ...
          <div className="bg-[#F8FAFC] border border-[#E5E7EB] rounded-2xl p-12 text-center my-8">
            <p className="text-base font-semibold text-[#111827] mb-2">No success stories match your filter</p>
